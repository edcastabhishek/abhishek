...
if (!guideMe.baseUrl) {
	guideMe.baseUrl = "https://edcastabhishek.github.io/abhishek/player/sumtotal_old/";
}
...
function getScriptCB() {
	...
	function loadGuideMeClientFiles() {
		if (window.self === window.top) {
			a.src = GmCXt.conf.baseUrl + 'gm_client_1763387398030.js';
		} else {
			a.src = GmCXt.conf.baseUrl + 'gm_client_iframe_1763387398030.js';
		}
